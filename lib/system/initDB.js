...
function initDB(m, client) {
  ...
  settings.id ??= '120363409104008533@newsletter'
  settings.nameid ??= "𓆩╚𓊈⃟⃞⇱Michiwii Oficial Channel⇲,⃟⃞𓊉╝𓆪"
  settings.type ??= 'Owner'
  settings.link ??= 'https://api.stellarwa.xyz'
  settings.banner ??= 'https://d.uguu.se/jRigTgZR.jpeg'
  settings.icon ??= 'https://o.uguu.se/YZqQsjXh.jpeg'
  settings.currency ??= 'Yenes'
  settings.namebot ??= 'Michiwii'
  settings.botname ??= 'MichiwiiSuperJSbot'  
  settings.owner ??= ''
